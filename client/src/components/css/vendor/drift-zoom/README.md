...
var options = {
	...
	// Which trigger attribute to pull the ZoomPane images source from.
	sourceAttribute: 'data-zoom',
	// How much to magnify the trigger by in the ZoomPane.
	// (e.g., `zoomFactor: 3` will result in a 900 px wide ZoomPane images
	...
	// scroll-gestures events on touch-enabled devices with the images as
	// a starting point
	touchDelay: 0,
